...
local cs = {
  ...
  wibmod: s.record('wibmod', [
    ...
    s.field('line_driver',  self.line_driver_selector,  default=[],          doc='Array of up to 2 values. 0 (Default setting), 1 (Short cable), 2 (25 m warm), 3 (35 m warm), 4 (25 m cold), 5 (35 m cold)'),
